%EM algorithm without acceleration. Estimates the parameter vector a of noisy measurements Y=Xa+e,
...
function [result EA EAtA]=RegularEM(y,F,varMatrix,sigma,x0,tol,maxIter)
